const uk: Record<string, string> = {
  ...
  'dashboard.patients': 'Пацієнти',
  'dashboard.appointments': 'Прийоми сьогодні',
  'dashboard.doctors': 'Лікарі',
  ...
  'dashboard.topDoctors': 'Найкращі лікарі',
  'dashboard.procedureStats': 'Процедури',
  'dashboard.appointmentCount': 'Прийоми',
  'dashboard.appointmentTrend': 'Тренд прийомів',
  'dashboard.weeklyLoad': 'Тижневе навантаження',
  'dashboard.doctorComparison': 'Порівняння лікарів',
  'dashboard.doctorWorkload': 'Розподіл навантаження',
  'dashboard.procedureRevenue': 'Дохід за процедурами',
  'dashboard.procedureDistribution': 'Розподіл процедур',
  'dashboard.count': 'Кількість',
  ...
  'settings.role': 'Роль',
  'settings.superuser': 'Суперюзер',
  'settings.administrator': 'Адміністратор',
