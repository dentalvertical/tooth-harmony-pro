...
const LoginPage = () => {
  ...
  const [password, setPassword] = useState(import.meta.env.VITE_SUPERUSER_PASSWORD || "");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: lang === "uk" ? "Невірний email або пароль." : "Invalid email or password.",
      variant: "destructive",
    });
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative">
      ...
      <Card className="w-full max-w-md shadow-elevated border-border/50 relative z-10">
        <CardHeader className="text-center pb-2">
          ...
          <h1 className="font-heading text-2xl font-bold text-foreground">{env.appName}</h1>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? (lang === "uk" ? "Вхід..." : "Signing in...") : t("login.submit")}
            </Button>
