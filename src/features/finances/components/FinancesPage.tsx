          ...
          <Card className="shadow-card">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-heading font-bold">{env.defaultCurrency}{totalPaid.toLocaleString()}</p>
              </div>
            </CardContent>
          </Card>
          <Card className="shadow-card">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-heading font-bold">{env.defaultCurrency}{totalPending.toLocaleString()}</p>
              </div>
            </CardContent>
          </Card>
          <Card className="shadow-card">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-heading font-bold">{env.defaultCurrency}{totalOverdue.toLocaleString()}</p>
              </div>
            </CardContent>
          </Card>
        </div>
                ...
                <TableBody>
                  {mockInvoices.map((inv) => (
                    <TableRow key={inv.id}>
                      ...
                      <TableCell className="font-medium">{env.defaultCurrency}{inv.amount.toLocaleString()}</TableCell>
